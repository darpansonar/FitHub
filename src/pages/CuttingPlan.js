...
function CuttingPlan() {
  return (
    <div className="py-6 px-4 sm:px-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-900">Cutting Diet Plan</h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="mt-4 bg-yellow-50 p-4 rounded-lg">
          ...
          <p className="text-gray-700">
            Enjoy one controlled cheat meal per week to boost metabolism and maintain sanity. 
            Example: 1 slice pizza + small salad.
          </p>
        </div>
